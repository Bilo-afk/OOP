...
//Here we inherited the Pearson class.
...

{
    ...
    Employee1.setFirstName("BELAL");
    Employee1.setLastName("ALHAMID");
    Employee1.setEmail("bilo123@gmailcom");
    Employee1.Print();
    ...
    //·‰ ÌƒœÌ «” œ⁄«¡ «·ÿ»«⁄… ≈·Ï ÿ»«⁄… √Ì ‘Ì¡ „‰ «·›∆… «·„‘ ﬁ…° »· ›ﬁÿ „‰ «·›∆… «·√”«”Ì…. //
    // ·–·ﬂ ·‰  ›Ìœ‰Ì ÿ—Ìﬁ… «·ÿ»«⁄… Â‰«° ÊÂ–Â „‘ﬂ·… ”Ì „ Õ·Â« ›Ì «·„Õ«÷—… «· «·Ì….
    Employee1.Print();
